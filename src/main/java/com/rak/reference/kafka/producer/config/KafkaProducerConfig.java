package com.rak.reference.kafka.producer.config;

import com.rak.reference.kafka.producer.beans.Item;
import com.rak.reference.kafka.producer.beans.serializer.ItemSerializer;
...
public class KafkaProducerConfig {
    ...
    public ProducerFactory<String, Item> producerFactory() {
        ...
        configProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "172.19.0.3:9092");
